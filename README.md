# 24-grantdao - Base Native Architecture
...
Community grants distribution platform

## Overview

GrantDAO provides a decentralized solution for proposal-based grant allocation and voting on both Base (EVM) and Stacks blockchains.
